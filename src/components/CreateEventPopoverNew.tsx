...
export default function CreateEventPopoverNew({ isOpen, onClose }: CreateEventPopoverProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex justify-center items-center">
      <div 
        className={`bg-mira-beige-light rounded-xl max-w-md w-full max-h-[90vh] overflow-y-auto transition-all duration-300 ${animationClass}`}
      >
        <form onSubmit={handleSubmit}>
          <div className="p-6">
            {/* Header */}
            <div className="flex justify-between items-start mb-8">
              <h1 className="text-2xl font-black font-source-code uppercase border-b-2 border-black pb-1">CREATE EVENT</h1>
              <button 
                type="button"
                onClick={handleClose}
            ...
            <div className="mb-6 relative">
              <div 
                className="flex items-center border-b-2 border-black cursor-pointer"
            ...
            <div className="mb-6">
              <div 
                className="flex items-center justify-between p-3 bg-black text-white rounded-md cursor-pointer"
            ...
            {/* Calendar */}
            <div className="mb-8">
              <div className="flex items-center justify-between p-3 bg-black text-white rounded-md mb-4">
                <button 
                  type="button"
              ...
              <input 
                type="hidden" 
                name="date" 
                value={selectedDay ? date.toISOString() : ''} 
                required
              />
                    ...
                    {day !== null ? (
                      <button
                        ...
                        className={`w-10 h-10 rounded-full flex items-center justify-center font-source-code
                          ${selectedDay === day ? 'bg-mira-orange text-white' : 'bg-mira-beige-light hover:bg-mira-beige'}
                        `}
